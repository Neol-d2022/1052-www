...
if(isset($_SESSION['login'])) {
  ...
  <?php
    ...
    $sql = "SELECT clientID, paid, got FROM " . $row["tableName"] . " INNER JOIN clients ON " . $row["tableName"] . ".clientID = clients.clientID INNER JOIN devices ON owner = devices.id WHERE clients.clientID = " . $_SESSION['login'] . " AND uuid = \"" . $uuid . "\";";
    $result = $conn->query($sql);
